<x-backend.layouts.master>
    ...
    <div class="card mx-5 my-5" style="background-color: white; overflow-x: auto;">
        ...
        <div class="container-fluid pt-2">
            <h4 class="text-center">Buyer-Wise Pending Tasks Summary (Factory) </h4>
            <div class="row">
                <div class="col-md-1">
                ...
                <div class="col-md-8">
                    <!-- Date Range Filter -->
                    <form action="{{ route('BuyerWiseFactoryTnaSummary') }}" method="GET">
                        <div class="row">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                ...
                                <button type="button" class="btn btn-outline-danger mt-4"
                                    onclick="window.location.href='{{ route('BuyerWiseFactoryTnaSummary') }}'">Reset</button>
                            </div>
                        </div>
                    </form>
    ...
    //             </tr>`
        ...
        $(document).ready(function() {
            ...
            function fetchDataAndUpdateTable() {
                $.ajax({
                    url: '{{ route('FAL_BuyerWiseFactoryTnaSummary') }}',
                    type: 'GET',
                    success: function(data) {
                        const newTableHash = getTableHash(data);
