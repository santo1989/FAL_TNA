                                    ...
                                    <tr>
                                        ...
                                        <td class="create_input_column">
                                            <select id="item" name="item" class="form-control" required>
                                                ...
                                                <option value="Romper"
                                                    {{  $job->item == 'Romper' ? 'selected' : '' }}>Romper</option>
                                        ...
                                        <td class="create_input_column">
                                            <div class="form-group">
                                                ...
                                                <select id="country" name="country" class="form-control">
                                                    <option value="{{  $job->destination }}">{{  $job->destination }}</option>
                                    ...
                                    <tr>
                                        ...
                                        <td class="create_input_column">
                                            <input type="number" step="0.01" name="total_cm"
                                                ...
                                                value="{{  $job->total_cm }}" required readonly>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="create_input_column">
                                            <select name="embroidery" class="form-control">
                                                ...
                                                <option value="Yes"
                                                    {{  $job->embroidery == 'Yes' ? 'selected' : '' }}>Yes</option>
                                                <option value="No"
                                                    {{  $job->embroidery == 'No' ? 'selected' : '' }}>No</option>
                                            </select>
                                        </td>
