     ...
     <div class="card mx-5 my-5" style="background-color: white; ">
         ...
         <div class="row p-1">
             <div class="col-12 ">
                 <div class="card">
                     <div class="card-body">
                         <form method="POST" action="{{ route('sops.update', $sops->id) }}"
                                     ...
                                     <tr>
                                         ...
                                         <td class="create_input_column">
                                                <input type="text" name="Perticulars" id="Perticulars" class="form-control"
                                                    value="{{ $sops->Perticulars }}" required> 
                                         </td>
                                         <td class="create_label_column">Days</td>
                                         <td class="create_input_column">
                                                <input type="number" name="day" id="day" class="form-control" value="{{ $sops->day }}" required>
                                         </td>
                                     </tr>
                                 </tbody>
                             </table>
                             ...
                             <div class="button-container">
                                 <button type="submit" class="btn btn-outline-success"><i class="fas fa-save"></i>
                                     Update</button>
                                 <a href="{{ route('sops.index') }}" class="btn btn-outline-secondary"><i
