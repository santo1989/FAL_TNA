...
<body style="background-color:#a5bcfc">
    ...
    <div class="container-fluid pt-2">
        <table class="table table-bordered table-hover text-center text-nowrap" id="PrintTable">
            <thead class="thead-dark">
                <tr>
                    <th class="sticky-header">SL</th>
                    <th class="sticky-header">Buyer</th>
                    <th class="sticky-header">Style</th>
            ...
            <tbody class="text-nowrap bg-light" id="tnaTableBody">
                @forelse ($tnas as $tna)
                    <tr>
                        <td class="sticky-column">{{ $tna->id }}</td>
                        <td class="sticky-column">{{ $tna->buyer }}</td>
                        <td class="sticky-column">{{ str_replace(',', ' ', $tna->style) }}</td>
                        <td class="sticky-column">{{ str_replace(',', ' ', $tna->po) }}</td>
                        <td>{{ $tna->item }}</td>
